...
#define SENSOR_TYPE_TEMPERATURE         32
...
#define SENSOR_TYPE_PROXIMITYNON        7
...
//Modified by huangzifan
#define ID_PROXIMITYNON                                      (ID_BASE+SENSOR_TYPE_PROXIMITYNON-1)
#define ID_SENSOR_MAX_HANDLE	  (ID_BASE+32)
#define ID_NONE							    (ID_BASE+33)
