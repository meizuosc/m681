...
void Auddrv_CheckInterruptTiming(void)
{
    ...
    else
    {
        ...
        {
            pr_debug("CheckInterruptTiming  Irq_time_t2 = %llu Irq_time_t1 = %llu Irq_time_t1 - Irq_time_t2 = %llu DL1_Interrupt_Interval_Limit = %d\n",
            ...
            {
                pr_debug("CheckInterruptTiming interrupt may be blocked Irq_time_t2 = %llu mDL1_Interrupt_Interval_Limit = %d\n",
