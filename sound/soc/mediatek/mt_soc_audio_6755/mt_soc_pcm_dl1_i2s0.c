...
static const struct snd_kcontrol_new Audio_snd_i2s0_controls[] = {
	...
	Audio_i2s0_Enum[2], Audio_i2s0_ExtCodec_EchoRef_Get, Audio_i2s0_ExtCodec_EchoRef_Set),
};
