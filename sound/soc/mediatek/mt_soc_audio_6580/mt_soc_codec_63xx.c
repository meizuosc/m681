...
static void VOW12MCK_Enable(bool enable)
{
	...
	pr_debug("VOW12MCK_Enable enable 82 no this\n");
}
...
static int mt6350_Readable_registers(struct snd_soc_codec *codec, unsigned int reg)
{
	return 1;
}

static int mt6350_volatile_registers(struct snd_soc_codec *codec, unsigned int reg)
{
	return 1;
}
...
static struct snd_soc_codec_driver soc_mtk_codec = {
	...
	.readable_register = mt6350_Readable_registers,
	.volatile_register = mt6350_volatile_registers,
