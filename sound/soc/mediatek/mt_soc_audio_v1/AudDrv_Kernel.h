...
typedef struct {
	...
	volatile uint32 Suspend_AFE_GAIN1_CONN2;
	volatile uint32 Suspend_AFE_GAIN1_CONN3;
	volatile uint32 Suspend_AFE_GAIN2_CONN2;
	volatile uint32 Suspend_AFE_GAIN2_CONN3;
