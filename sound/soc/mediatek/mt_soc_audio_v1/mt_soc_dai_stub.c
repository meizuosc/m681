...
static struct snd_soc_dai_driver mtk_dai_stub_dai[] = {
	 ...
	 },
	{
	 ...
	 .name = MT_SOC_VOICE_CALL_BT_NAME,
	 .ops = &mtk_dai_stub_ops,
	 },
	{
	 .playback = {
	 ...
	 .name = MT_SOC_VOICE_CALL_EXT_BT_NAME,
	 .ops = &mtk_dai_stub_ops,
	 },
	{
	 .playback = {
	 ...
	 .name = MT_SOC_VOICE_CALL_EXTINT_BT_NAME,
	 .ops = &mtk_dai_stub_ops,
	 },
	{
	 .playback = {
...

	{
	 ...
	 .name = MT_SOC_ADC2ADCI2S2DAI_NAME,
	 .ops = &mtk_dai_stub_ops,
	 },
...
#endif
	ret = platform_driver_register(&mtk_dai_stub_driver);
	return ret;
}
