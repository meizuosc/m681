...
#define ICM20608_MAX_MPU_MEM      (256 * 12 + 512)
...
#define ICM20608_ID               0xAE      /* unique WHOAMI */
...
#define DMP_IMAGE_SIZE           (3203 + 112)
 ...
 *	@gyro_wakeup_enabled: wakeup gyro enabled.
 *	@accel_wakeup_enabled: wakeup accel enabled.
...
#define TIMESTAMP_FIFO_SIZE 64
	...
	u8 gyro_wakeup_enabled;
	u8 accel_wakeup_enabled;
	u8 quat_wakeup_enabled; 
	u32 fifo_count;
...
/*  *****below this line, it is non-DMP, no needs to on/off power */
	...
	ATTR_GYRO_WAKEUP_ENABLE,
	ATTR_GYRO_RATE,
	ATTR_ACCEL_ENABLE,
	ATTR_ACCEL_FIFO_ENABLE,
	ATTR_ACCEL_WAKEUP_ENABLE,
	ATTR_ACCEL_RATE,
	ATTR_COMPASS_ENABLE,
	ATTR_COMPASS_RATE,
