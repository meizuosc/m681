...
#endif
/* Gesture Keys */
#define KEY_DMP_SH_TH_Y             (KEY_CPASS_STATUS_CHK + 1)
...
#define KEY_VIB_DET_RATIO           (KEY_DMP_RUN_CNTR + 1)
#define KEY_VIB_MAG_TH              (KEY_VIB_DET_RATIO  + 1)
#define KEY_VIB_K                   (KEY_VIB_MAG_TH + 1)
#define KEY_VIB_K_1                 (KEY_VIB_K + 1)

#define KEY_ACC_SCALE               (KEY_VIB_K_1 + 1)

/* Sensor's ODR */
#define KEY_CFG_3QUAT_ODR           (KEY_ACC_SCALE + 1)
