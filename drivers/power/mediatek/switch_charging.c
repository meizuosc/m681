...
extern int g_charging_current_by_temp;
#ifdef CONFIG_MTK_SWITCH_INPUT_OUTPUT_CURRENT_SUPPORT
/*input-output curent distinction*/
kal_uint32 g_bcct_input_flag = 0;
kal_uint32 g_bcct_input_value = 0;
#endif
kal_uint32 g_full_check_count = 0;
kal_uint32 g_rechg_check_count = 0;
...
//charging switch
kal_uint32 g_charging_enable = 0;
//end
  /* ///////////////////////////////////////////////////////////////////////////////////////// */
  /* // PUMP EXPRESS */
  /* ///////////////////////////////////////////////////////////////////////////////////////// */
...
static kal_uint32 get_constant_voltage(void)
{
	kal_uint32 cv;
#ifdef CONFIG_MTK_BIF_SUPPORT
	kal_uint32 vbat_bif;
	kal_uint32 vbat_auxadc;
	kal_uint32 vbat, bif_ok;
	int i;
#endif
...
static void switch_charger_set_vindpm(kal_uint32 chr_v)
{
	/*kal_uint32 delta_v = 0; */
	kal_uint32 vindpm = 0;
...
void select_charging_curret(void)
{
	if (g_ftm_battery_flag) {
		...
		if (BMT_status.charger_type == STANDARD_HOST) {
			...
			if(1 == g_charging_current_by_temp){				
				g_temp_input_CC_value = AC_CHARGER_INPUT_CURRENT_0_10;				
			}
			else 
...
#endif
			if(1 == g_charging_current_by_temp){				
				g_temp_CC_value = AC_CHARGER_CURRENT_0_10;				
			}
			else
			g_temp_CC_value = AC_CHARGER_CURRENT;
#if defined(CONFIG_MTK_PUMP_EXPRESS_PLUS_SUPPORT)
...
void charging_enable_ctrl(int enable)
{
	printk("charging_enable_ctrl entry\n");
	...
	battery_log(BAT_LOG_FULL, "[BATTERY] pchr_turn_on_charging(), enable =%d !\r\n",
		...
		g_charging_enable = 0;
		/*meta usblimit 100ma fastchg 100ma*/
		/*g_temp_input_CC_value = CHARGE_CURRENT_0_00_MA;
		g_temp_CC_value = CHARGE_CURRENT_0_00_MA;
		battery_charging_control(CHARGING_CMD_SET_INPUT_CURRENT,
						 &g_temp_input_CC_value);
	...
	printk("charging_enable_ctrl end\n");	
}
...
static void pchr_turn_on_charging(void)
{
	...
	} else if (((0 == g_charging_enable)&&(g_platform_boot_mode == FACTORY_BOOT)) ||(g_platform_boot_mode == META_BOOT) || (g_platform_boot_mode == ADVMETA_BOOT)) {
		battery_log(BAT_LOG_CRTI,
