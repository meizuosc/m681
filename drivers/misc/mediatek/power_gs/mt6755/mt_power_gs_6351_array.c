...
const unsigned int MT6351_PMIC_REG_gs_flightmode_suspend_mode_32k_removal_data[] = {
/* Address     Mask        Golden Setting Value */
	0x0EA2, 0xE000, 0x0000,/* AUXADC_CON0 */
};

const unsigned int *MT6351_PMIC_REG_gs_flightmode_suspend_mode_32k_removal = MT6351_PMIC_REG_gs_flightmode_suspend_mode_32k_removal_data;

unsigned int MT6351_PMIC_REG_gs_flightmode_suspend_mode_32k_removal_len = 3;
...
const unsigned int *MT6351_PMIC_REG_gs_early_suspend_deep_idle__mode = MT6351_PMIC_REG_gs_early_suspend_deep_idle__mode_data;
