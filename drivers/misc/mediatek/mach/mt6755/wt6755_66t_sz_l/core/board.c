...
#define MSDC_SDIO_FLAG    (MSDC_EXT_SDIO_IRQ | MSDC_HIGHSPEED | MSDC_UHS1)
	...
	{MSDC_HS400_MODE, 0x188, (0x1f << 2), 0x0},	/* EMMC50_PAD_DS_TUNE[MSDC_EMMC50_PAD_DS_TUNE_DLY1] */
	{MSDC_HS400_MODE, 0x188, (0x1f << 12), 0x13},   /* EMMC50_PAD_DS_TUNE[MSDC_EMMC50_PAD_DS_TUNE_DLY3] */
	...
	{MSDC_HS400_MODE, 0xf0, (0x1f << 22), 0x0},	/* PAD_TUNE[MSDC_PAD_TUNE_CMDRRDLY] */

	/* write ett settings */
	{MSDC_HS200_MODE, 0xb4, (0x7 << 0), 0x1},	/* PATCH_BIT1[MSDC_PB1_WRDAT_CRCS_TA_CNTR] */
	{MSDC_HS200_MODE, 0xf0, (0x1f << 0), 0x0},	/* PAD_TUNE[MSDC_PAD_TUNE_DATWRDLY] */
	{MSDC_HS200_MODE, 0x4, (0x1 << 8), 0x1},	/* MSDC_IOCON[MSDC_IOCON_W_DSPL] */

	/* read ett settings */
	{MSDC_HS200_MODE, 0xf0, (0x1f << 8), 0x16},	/* PAD_TUNE[MSDC_PAD_TUNE_DATRRDLY] */
	{MSDC_HS200_MODE, 0xf8, 0xffffffff, 0x16161616},/* DAT_RD_DLY0[MSDC_DAT_RDDLY0] */
	{MSDC_HS200_MODE, 0xfc, 0xffffffff, 0x16161616},/* DAT_RD_DLY0[MSDC_DAT_RDDLY0] */
	{MSDC_HS200_MODE, 0x4, (0x1 << 2), 0x1},	/* MSDC_IOCON[MSDC_IOCON_R_D_SMPL] */
    }; 
	...
	.clk_src              = MSDC1_CLKSRC_DEFAULT,
        ...
        .data_pins            = 4,
        .data_offset          = 0,
	.flags = MSDC_SYS_SUSPEND | MSDC_HIGHSPEED | MSDC_CD_PIN_EN | MSDC_REMOVABLE | MSDC_UHS1 | MSDC_DDR,
        .dat0rddly            = 0,
        .dat1rddly            = 0,
        .dat2rddly            = 0,
        .dat3rddly            = 0,
        ...
        .host_function        = MSDC_SD,
        .boot	                = 0,
        .cd_level             = MSDC_CD_HIGH,//MSDC_CD_LOW,
    };
#endif
