...
#define GF516M_SECDEV_CMD_SUSPEND_RESUME_SAMPLE  14
...
/**
 * SECDEV_CMD_SUSPEND_SAMPLE data structure
 */
typedef struct {
    uint8_t flag;//0:resume sample, 1:suspend sample, other :error 
} suspend_resume_sample_t;
...
typedef struct {
    ...
    union {
	    ...
	    suspend_resume_sample_t suspend_resume_sample;
    };
