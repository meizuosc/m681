...
//	rtc_write(0x7012, 0x40CF);
//	rtc_write(0x7004, 0x3AEA);
//	
//	pmic_config_interface(MT6351_PMIC_RG_SRCLKEN_IN0_HW_MODE_ADDR, 1, MT6351_PMIC_RG_SRCLKEN_IN0_HW_MODE_MASK, MT6351_PMIC_RG_SRCLKEN_IN0_HW_MODE_SHIFT);
//	pmic_config_interface(MT6351_PMIC_RG_SRCLKEN_IN1_HW_MODE_ADDR, 1, MT6351_PMIC_RG_SRCLKEN_IN1_HW_MODE_MASK, MT6351_PMIC_RG_SRCLKEN_IN1_HW_MODE_SHIFT);
//	pmic_config_interface(MT6351_EOSC_CALI_CON0, 1, MT6351_PMIC_EOSC_CALI_START_MASK, MT6351_PMIC_EOSC_CALI_START_SHIFT);
//	
