...
#endif
/*------ PDN Section -----------------------*/
#define PDN_FOR_UART1   MT_CG_INFRA1_UART0_CG_STA
#define PDN_FOR_UART2   MT_CG_INFRA1_UART1_CG_STA
/*
#define PDN_FOR_UART3   MT_CG_INFRA1_UART2_CG_STA
#define PDN_FOR_UART4   MT_CG_INFRA1_UART3_CG_STA
*/
#if defined(CONFIG_MTK_CLKMGR)
