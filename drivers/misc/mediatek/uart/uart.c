...
static const char * const intrrupt[] = { "Modem Status Chg", "Tx Buffer Empty",
...
static int mtk_uart_probe(struct platform_device *pdev)
{
	...
	pr_debug("[UART][CCF]mtk_platform_uart_probe CONFIG_MTK_CLKMGR is not defined!\n");
#endif				/*!defined(CONFIG_MTK_CLKMGR) */
