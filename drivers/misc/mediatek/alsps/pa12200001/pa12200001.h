...
#define PA12_DRIVER_VERSION_H		"1.92.1.03"
...
/*-----------------------------------------------------------------------------*/
#define PA12_PS_TH_HIGH			55
#define PA12_PS_TH_LOW				40
...
/*-----------------------------------------------------------------------------*/
#define PA12_PS_OFFSET_DEFAULT	20	 	//Modify by huangzifan at 2015.11.10 /* for X-talk cannceling */
#define PA12_PS_OFFSET_EXTRA		9
#define PA12_PS_OFFSET_MAX		100
#define PA12_PS_OFFSET_MIN			0
#define PA12_FAST_CAL				1		
#define PA12_FAST_CAL_ONCE			0
#define PS_CALIB_LIMIT          1
#define PA12_CAL_MAX_ALS_COUNT  19000

/* pa122 als/ps parameter setting */
#define PA12_ALS_GAIN		1 	/* 0:125lux | 1:1000lux | 2:2000lux | 3:10000lux */
#define PA12_LED_CURR		1 	/* 0:150mA | 1:100mA | 2:50mA | 3:25mA */
...
#define PA12_INT_TYPE		1 	/* 0:Window type | 1:Hysteresis type for Auto Clear flag */
