...
#define BTS_FUN(f)		pr_debug(BTS_TAG"%s\n", __func__)
#define BTS_ERR(fmt, args...)	pr_err(KERN_ERR BTS_TAG"%s %d : "fmt, __func__, __LINE__, ##args)
#define BTS_LOG(fmt, args...)	pr_debug(KERN_ERR BTS_TAG fmt, ##args)
#define BTS_VER(fmt, args...)  pr_debug(KERN_ERR BTS_TAG"%s: "fmt, __func__, ##args) //((void)0)
