...
#define USB11PHY_READ32(offset)         __raw_readl((void __iomem *)(((unsigned long)g_musbfsh->phy_base)+0x800+offset))
#define USB11PHY_READ8(offset)          __raw_readb((void __iomem *)(((unsigned long)g_musbfsh->phy_base)+0x800+offset))
#define USB11PHY_WRITE8(offset, value)  __raw_writeb(value, (void __iomem *)(((unsigned long)g_musbfsh->phy_base)+0x800+offset))
