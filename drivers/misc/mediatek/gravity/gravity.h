...
#define GRAV_ERR(fmt, args...)		pr_err(KERN_ERR GRAV_TAG"%s %d : "fmt, __func__, __LINE__, ##args)
#define GRAV_LOG(fmt, args...)		pr_debug(KERN_ERR GRAV_TAG fmt, ##args)
#define GRAV_VER(fmt, args...)   	pr_debug(KERN_ERR GRAV_TAG"%s: "fmt, __func__, ##args) //((void)0)
