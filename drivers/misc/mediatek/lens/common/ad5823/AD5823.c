...
#define PLATFORM_DRIVER_NAME "lens_actuatorAD5823"
...
static inline int getAD5823Info(__user stAD5823_MotorInfo * pstMotorInfo)
{
...
static inline int moveAD5823(unsigned long a_u4Position)
{
	int ret = 0;
...
static inline int setAD5823Inf(unsigned long a_u4Position)
{
	spin_lock(&g_AD5823_SpinLock);
...
static inline int setAD5823Macro(unsigned long a_u4Position)
{
	spin_lock(&g_AD5823_SpinLock);
...
static inline int Register_AD5823_CharDrv(void)
{
...
static inline void Unregister_AD5823_CharDrv(void)
{
