...
extern kal_uint16 MT9P017MIPI_read_cmos_sensor(kal_uint32 addr);*//*to avoid build error */
...
static int s4MT9P017AF_ReadReg(unsigned short *a_pu2Result)
{
	...
	*a_pu2Result = 0;	/*MT9P017MIPI_read_cmos_sensor(0x30f2) << 2; *//*to avoid build error */
...
static inline int getMT9P017AFInfo(__user stMT9P017AF_MotorInfo * pstMotorInfo)
{
...
static inline int moveMT9P017AF(unsigned long a_u4Position)
{
...
static inline int setMT9P017AFInf(unsigned long a_u4Position)
{
	g_u4MT9P017AF_INF = a_u4Position;
	return 0;
}

static inline int setMT9P017AFMacro(unsigned long a_u4Position)
{
...
static inline int Register_MT9P017AF_CharDrv(void)
{
...
static inline void Unregister_MT9P017AF_CharDrv(void)
{
	/* Release char driver */
...
#define IMG_SENSOR_I2C_GROUP_ID 0	/*To avoid build error */
static unsigned short force[] = {
	IMG_SENSOR_I2C_GROUP_ID, MT9P017AF_VCM_WRITE_ID, I2C_CLIENT_END, I2C_CLIENT_END
};
static const unsigned short *const forces[] = { force, NULL };

static struct i2c_client_address_data addr_data;	/* = {.forces = forces, }; *//*To avoid build error */
...
struct i2c_driver MT9P017AF_i2c_driver = {
	...
	/*.address_data = &addr_data, *//*To avoid build error */
};
