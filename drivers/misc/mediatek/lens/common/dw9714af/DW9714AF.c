...
static inline int getAFInfo(__user stDW9714AF_MotorInfo * pstMotorInfo)
{
...
#ifdef LensdrvCM3
static inline int getAFMETA(__user stDW9714AF_MotorMETAInfo * pstMotorMETAInfo)
{
...
static long AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	...
	case DW9714AFIOC_G_MOTORINFO:
		i4RetValue = getAFInfo((__user stDW9714AF_MotorInfo *) (a_u4Param));
		break;
#ifdef LensdrvCM3
	case DW9714AFIOC_G_MOTORMETAINFO:
		i4RetValue = getAFMETA((__user stDW9714AF_MotorMETAInfo *) (a_u4Param));
		break;
#endif
