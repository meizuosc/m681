...
static inline int getBU6424AFInfo(__user stBU6424AF_MotorInfo * pstMotorInfo)
{
...
static inline int moveBU6424AF(unsigned long a_u4Position)
{
	int ret = 0;
...
static inline int setBU6424AFInf(unsigned long a_u4Position)
{
	spin_lock(&g_BU6424AF_SpinLock);
...
static inline int setBU6424AFMacro(unsigned long a_u4Position)
{
	spin_lock(&g_BU6424AF_SpinLock);
...
static inline int Register_BU6424AF_CharDrv(void)
{
...
static inline void Unregister_BU6424AF_CharDrv(void)
{
