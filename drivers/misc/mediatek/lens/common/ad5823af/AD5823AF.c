...
#define PLATFORM_DRIVER_NAME "lens_actuatorAD5823AF"
...
static inline int getAD5823AFInfo(__user stAD5823AF_MotorInfo * pstMotorInfo)
{
...
static inline int moveAD5823AF(unsigned long a_u4Position)
{
	int ret = 0;
...
static inline int setAD5823AFInf(unsigned long a_u4Position)
{
	spin_lock(&g_AD5823AF_SpinLock);
...
static inline int setAD5823AFMacro(unsigned long a_u4Position)
{
	spin_lock(&g_AD5823AF_SpinLock);
...
static inline int Register_AD5823AF_CharDrv(void)
{
...
static inline void Unregister_AD5823AF_CharDrv(void)
{
