...
static inline int getOV8825AFInfo(__user stOV8825AF_MotorInfo * pstMotorInfo)
{
...
static inline int moveOV8825AF(unsigned long a_u4Position)
{
	int ret = 0;
...
static inline int setOV8825AFInf(unsigned long a_u4Position)
{
	spin_lock(&g_OV8825AF_SpinLock);
...
static inline int setOV8825AFMacro(unsigned long a_u4Position)
{
	spin_lock(&g_OV8825AF_SpinLock);
...
static inline int Register_OV8825AF_CharDrv(void)
{
...
static inline void Unregister_OV8825AF_CharDrv(void)
{
	/* Release char driver */
