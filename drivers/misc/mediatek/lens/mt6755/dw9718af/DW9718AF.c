...
static inline int getDW9718AFInfo(__user stDW9718AF_MotorInfo * pstMotorInfo)
{
...
static inline int moveDW9718AF(unsigned long a_u4Position)
{
	int ret = 0;
...
static inline int setDW9718AFInf(unsigned long a_u4Position)
{
	spin_lock(&g_DW9718AF_SpinLock);
...
static inline int setDW9718AFMacro(unsigned long a_u4Position)
{
	spin_lock(&g_DW9718AF_SpinLock);
...
static inline int Register_DW9718AF_CharDrv(void)
{
...
static inline void Unregister_DW9718AF_CharDrv(void)
{
