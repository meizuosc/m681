...
#define I2C_REGISTER_ID            0x37
#define PLATFORM_DRIVER_NAME "lens_actuator_bu6424af"
#define AF_DRIVER_CLASS_NAME "actuatordrv_bu6424af"
...
static inline int getAFInfo(__user stBU6424AF_MotorInfo * pstMotorInfo)
{
...
static long AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	...
	case BU6424AFIOC_G_MOTORINFO:
		i4RetValue = getAFInfo((__user stBU6424AF_MotorInfo *) (a_u4Param));
		break;
