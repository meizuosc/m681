...
static struct i2c_board_info kd_lens_dev __initdata = { I2C_BOARD_INFO("LC898122AF", 0x48) };
...
static struct i2c_client *g_pstLC898122AF_I2Cclient;

static dev_t g_LC898122AF_devno;
static struct cdev *g_pLC898122AF_CharDrv;
static struct class *actuator_class;

static int g_s4LC898122AF_Opened;
static long g_i4MotorStatus;
static long g_i4Dir;
static unsigned long g_u4LC898122AF_INF;
...
#endif
static inline int getLC898122AFInfo(__user stLC898122AF_MotorInfo * pstMotorInfo)
{
...
static inline int moveLC898122AF(unsigned long a_u4Position)
{
...
static inline int setLC898122AFInf(unsigned long a_u4Position)
{
	spin_lock(&g_LC898122AF_SpinLock);
...
static inline int setLC898122AFMacro(unsigned long a_u4Position)
{
	spin_lock(&g_LC898122AF_SpinLock);
...
/* ////////////////////////////////////////////////////////////// */
static long LC898122AF_Ioctl(struct file *a_pstFile,
...
static inline int Register_LC898122AF_CharDrv(void)
{
	...
	vcm_device =
	    device_create(actuator_class, NULL, g_LC898122AF_devno, NULL, LC898122AF_DRVNAME);
...
static inline void Unregister_LC898122AF_CharDrv(void)
{
