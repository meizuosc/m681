...
#define GT9762AFIOC_G_MOTORINFO _IOR(GT9762AF_MAGIC, 0, stGT9762AF_MotorInfo)

#define GT9762AFIOC_T_MOVETO _IOW(GT9762AF_MAGIC, 1, u32)

#define GT9762AFIOC_T_SETINFPOS _IOW(GT9762AF_MAGIC, 2, u32)

#define GT9762AFIOC_T_SETMACROPOS _IOW(GT9762AF_MAGIC, 3, u32)
#ifdef LensdrvCM3
#define GT9762AFIOC_G_MOTORMETAINFO _IOR(GT9762AF_MAGIC, 4, stGT9762AF_MotorMETAInfo)
#endif
