...
#define AF_DRVNAME "AD5820AF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x6C
#define PLATFORM_DRIVER_NAME "lens_actuator_ad5820af"
#define AF_DRIVER_CLASS_NAME "actuatordrv_ad5820af"
...
static inline int getAFInfo(__user stAD5820AF_MotorInfo * pstMotorInfo)
{
...
#ifdef LensdrvCM3
static inline int getAFMETA(__user stAD5820AF_MotorMETAInfo * pstMotorMETAInfo)
{
...
static long AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	...
	case AD5820AFIOC_G_MOTORINFO:
		i4RetValue = getAFInfo((__user stAD5820AF_MotorInfo *) (a_u4Param));
		break;
#ifdef LensdrvCM3
	case AD5820AFIOC_G_MOTORMETAINFO:
		i4RetValue = getAFMETA((__user stAD5820AF_MotorMETAInfo *) (a_u4Param));
		break;
#endif
