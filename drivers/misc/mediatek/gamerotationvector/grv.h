...
#define GRV_ERR(fmt, args...)		pr_err(KERN_ERR GRV_TAG"%s %d : "fmt, __func__, __LINE__, ##args)
#define GRV_LOG(fmt, args...)		pr_debug(KERN_ERR GRV_TAG fmt, ##args)
#define GRV_VER(fmt, args...)   	pr_debug(KERN_ERR GRV_TAG"%s: "fmt, __func__, ##args) //((void)0)
#define GRV_DBGMSG pr_debug("%s, %d\n", __func__, __LINE__);
#else
#define GRV_TAG					"<GRV> "
#define GRV_FUN(f)	
