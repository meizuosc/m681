...
#define CAM_CAL_I2C_BUSNUM_S5K5E8 1
...
*
********************************************************************************/
#define CAM_CAL_DRVNAME_S5K5E8 "s5k5e8_eeprom"
#define CAM_CAL_I2C_GROUP_ID 0
/*******************************************************************************
*
********************************************************************************/
static struct i2c_board_info kd_cam_cal_dev __initdata = {
	I2C_BOARD_INFO(CAM_CAL_DRVNAME_S5K5E8, 0xAa >> 1)    //a0-a1-aa
};
...
//add by allenyao
extern kal_uint8  s5k5e8_u_r_h,s5k5e8_u_r_l,s5k5e8_u_b_h,s5k5e8_u_b_l,s5k5e8_u_g_h,s5k5e8_u_g_l;
extern kal_uint8  s5k5e8_g_r_h,s5k5e8_g_r_l,s5k5e8_g_b_h,s5k5e8_g_b_l,s5k5e8_g_g_h,s5k5e8_g_g_l;
extern kal_uint8 s5k5e8_moudu_id;
//end
...
bool selective_read_byte_s5k5e8(u32 addr, BYTE *data, u16 i2c_id)
{
	/* CAM_CALDB("selective_read_byte\n"); */

	//u8 page = addr / PAGE_SIZE_; /* size of page was 256 */
	//u8 offset = addr % PAGE_SIZE_;
	u8 page = 1; /* this eeprom is only one page*/
	u32 offset = addr ;
	char pu_send_cmd[2] = {(char)(addr >> 8), (char)(addr & 0xFF) };
	kdSetI2CSpeed(EEPROM_I2C_SPEED);

	if (iReadRegI2C(&pu_send_cmd, 2, (u8 *)data, 1, i2c_id + (page << 1)) < 0) {
		CAM_CALERR("fail selective_read_byte addr =0x%x data = 0x%x,page %d, offset 0x%x",
		 addr, *data, page, offset);
		return false;
	}
	 CAM_CALDB("selective_read_byte addr =0x%x data = 0x%x,page %d, offset 0x%x\n", addr,
	*data,page,offset); 
	return true;
}
u8 s5k5e8_awb_data[12];
u8 s5k5e8_mid[2];
u16 golden_r = 0x26c;//fix value
u16 golden_b = 0x23a;//fix value
int selective_read_region_s5k5e8(u32 addr, BYTE *data, u16 i2c_id, u32 size)
{
	...
	extern kal_uint8 s5k5e8_moudu_id;
	#endif
	s5k5e8_mid[0]=s5k5e8_moudu_id;
	s5k5e8_mid[1]=0;
	
	s5k5e8_awb_data[0]=s5k5e8_u_r_h;
	s5k5e8_awb_data[1]=s5k5e8_u_r_l;
	s5k5e8_awb_data[2]=s5k5e8_u_b_h;
	s5k5e8_awb_data[3]=s5k5e8_u_b_l;
	s5k5e8_awb_data[4]=s5k5e8_u_g_h;
	s5k5e8_awb_data[5]=s5k5e8_u_g_l;
	
	//s5k5e8_awb_data[6]=s5k5e8_g_r_h;
	//s5k5e8_awb_data[7]=s5k5e8_g_r_l;
	s5k5e8_awb_data[6]=(golden_r>>8)&0xFF;
	s5k5e8_awb_data[7]=(golden_r)&0xFF;
	//s5k5e8_awb_data[8]=s5k5e8_g_b_h;
	//s5k5e8_awb_data[9]=s5k5e8_g_b_l;
	s5k5e8_awb_data[8]=(golden_b>>8)&0xFF;
	s5k5e8_awb_data[9]=(golden_b)&0xFF;
	s5k5e8_awb_data[10]=s5k5e8_g_g_h;
	s5k5e8_awb_data[11]=s5k5e8_g_g_l;

	printk("s5k5e8_mid[0] is %d ,s5k5e8_mid[1] is %d,allenyao\n",s5k5e8_mid[0] ,s5k5e8_mid[1]);
	
	printk("s5k5e8_awb_data[0]is %d ,s5k5e8_awb_data[1] is %d,allenyao\n",s5k5e8_awb_data[0] ,s5k5e8_awb_data[1]);
	printk("s5k5e8_awb_data[2]is %d ,s5k5e8_awb_data[3] is %d,allenyao\n",s5k5e8_awb_data[2] ,s5k5e8_awb_data[3]);
	
	printk("s5k5e8_awb_data[6]is %d ,s5k5e8_awb_data[7] is %d,allenyao\n",s5k5e8_awb_data[6] ,s5k5e8_awb_data[7]);
	printk("s5k5e8_awb_data[8]is %d ,s5k5e8_awb_data[9] is %d,allenyao\n",s5k5e8_awb_data[8] ,s5k5e8_awb_data[9]);


	if(2==size){
		printk("s5k5e8_awb_data,come to size is 2,allenyao\n");
		buff[0]=s5k5e8_mid[0];
		buff[1]=s5k5e8_mid[1];
		//buff=(BYTE *)(&s5k5e8_mid[0]);
	}
	else	{
		buff[0]=s5k5e8_awb_data[0];
		buff[1]=s5k5e8_awb_data[1];
		buff[2]=s5k5e8_awb_data[2];
		buff[3]=s5k5e8_awb_data[3];
		buff[4]=s5k5e8_awb_data[4];
		buff[5]=s5k5e8_awb_data[5];
		buff[6]=s5k5e8_awb_data[6];
		buff[7]=s5k5e8_awb_data[7];
		buff[8]=s5k5e8_awb_data[8];
		buff[9]=s5k5e8_awb_data[9];
		buff[10]=s5k5e8_awb_data[10];
		buff[11]=s5k5e8_awb_data[11];
		//buff=(BYTE *)(&s5k5e8_awb_data[0]);
	}
	ret=ret+1;
	...
	u32 awb_addr=0;
	awb_addr=awb_offset+addr;
	while (size_to_read > 0) {
		if (selective_read_byte_s5k5e8(addr, (u8 *)buff, S5K5E8_DEVICE_ID)) {
			addr += 1;
			buff += 1;
			size_to_read -= 1;
			ret += 1;
...
#endif
{
	...
	case CAM_CALIOC_G_READ:
		...
		i4RetValue = selective_read_region_s5k5e8(ptempbuf->u4Offset, pu1Params,
		S5K5E8_DEVICE_ID, ptempbuf->u4Length);
...
//add  by allenyao for 5e8 awb group
static int FIND_5E8_AWB_FROUP(void)
{
	int ret=0;char buf[1];char buf1[1];
	int strart_reg=0x0a04,offset=24;
	write_cmos_sensor_otp(0x0a00,0x04);
	write_cmos_sensor_otp(0x0a02,0x04);//set page 
	write_cmos_sensor_otp(0x0a00,0x01);//set read mode of nvram

	selective_read_byte_s5k5e8(strart_reg,buf,S5K5E8_DEVICE_ID);
	selective_read_byte_s5k5e8(strart_reg+offset,buf1,S5K5E8_DEVICE_ID);
	if(1==buf[0])
		awb_offset=0x0a04;
	else if(1==buf1[0])
		awb_offset=0x0a04+24;
	else{
		awb_offset=-1;
		printk("there is not otp data");
	}	
	return 0;
}

 void S5K5E8_OTP_EXIT(void)
{
	write_cmos_sensor_otp(0x0a00,0x04);
	write_cmos_sensor_otp(0x0a00,0x00);//disable nvram control
}
...
static inline int RegisterCAM_CALCharDrv(void)
{
	...
	if (alloc_chrdev_region(&g_CAM_CALdevno, 0, 1, CAM_CAL_DRVNAME_S5K5E8)) {
		CAM_CALDB("[S24CAM_CAL] Allocate device no failed\n");

		return -EAGAIN;
	}
#else
	if (register_chrdev_region(g_CAM_CALdevno , 1 , CAM_CAL_DRVNAME_S5K5E8)) {
	...
	CAM_CAL_class = class_create(THIS_MODULE, "s5k5e8_eeprom");
	if (IS_ERR(CAM_CAL_class)) {
		int ret = PTR_ERR(CAM_CAL_class);
		CAM_CALDB("Unable to create class, err = %d\n", ret);
		return ret;
	}
	CAM_CAL_device = device_create(CAM_CAL_class, NULL, g_CAM_CALdevno, NULL, CAM_CAL_DRVNAME_S5K5E8);
...
static const struct i2c_device_id CAM_CAL_i2c_id[] = {{CAM_CAL_DRVNAME_S5K5E8, 0}, {} };
...
static struct i2c_driver CAM_CAL_i2c_driver = {
	...
	.driver.name = CAM_CAL_DRVNAME_S5K5E8,
...
static int CAM_CAL_i2c_detect(struct i2c_client *client, int kind, struct i2c_board_info *info)
{
	strcpy(info->type, CAM_CAL_DRVNAME_S5K5E8);
	return 0;
}
#endif
static int CAM_CAL_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	g_pstI2Cclient->addr = S5K5E8_DEVICE_ID >> 1;
...
{
	#if 1
	i2c_register_board_info(CAM_CAL_I2C_BUSNUM_S5K5E8, &kd_cam_cal_dev, 1);
	printk("come to %s,%d,allenyao\n",__func__,__LINE__);
