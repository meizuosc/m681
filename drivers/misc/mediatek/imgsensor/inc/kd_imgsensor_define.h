...
typedef enum {
	...
	SENSOR_FEATURE_SET_LONGEXP_PARAM,
	SENSOR_FEATURE_CANCEL_LONGEXP,
	SENSOR_FEATURE_GET_CAP_PIXEL_CLOCK_FREQ,
	SENSOR_FEATURE_GET_CAP_PERIOD,
	SENSOR_FEATURE_GET_MAXFRAMELENGTH_MARGIN,
	SENSOR_FEATURE_MAX
