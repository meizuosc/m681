...
UINT32 OV13853_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);	//wangjie, back cam
UINT32 OV13853QTECH_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);	//wangjie, qtech back cam
UINT32 OV13853OFILM_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);	//jerryxie, ofilm back cam
UINT32 OV13853_SUNNY2_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);	//jerryxie, ofilm back cam
...
UINT32 S5K5E8YX_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);	//wangjie, front cam
/*HI*/
...
#endif
//add by wangjie, back cam
#if defined(OV13853_MIPI_RAW)
    {OV13853_SENSOR_ID, SENSOR_DRVNAME_OV13853_MIPI_RAW, OV13853_MIPI_RAW_SensorInit},
#endif
//add end
//add by wangjie, qtech back cam
#if defined(OV13853_QTECH_MIPI_RAW)
    {OV13853QTECH_SENSOR_ID, SENSOR_DRVNAME_OV13853QTECH_MIPI_RAW, OV13853QTECH_MIPI_RAW_SensorInit},
#endif
//add end
//add by jerryxie, ofilm back cam
#if defined(OV13853_OFILM_MIPI_RAW)
    {OV13853OFILM_SENSOR_ID, SENSOR_DRVNAME_OV13853OFILM_MIPI_RAW, OV13853OFILM_MIPI_RAW_SensorInit},
#endif
//end
#if defined(OV13853_SUNNY2_MIPI_RAW)
    {OV13853SUNNY2_SENSOR_ID, SENSOR_DRVNAME_OV13853SUNNY2_MIPI_RAW, OV13853_SUNNY2_MIPI_RAW_SensorInit},
#endif
//end
