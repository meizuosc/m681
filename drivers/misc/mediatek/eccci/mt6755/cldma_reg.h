...
#define CLDMA_AP_L2TISAR0		(0x0410) /* Level 2 Interrupt Status and Acknowledgement Register (TX Part) */
#define CLDMA_AP_L2TISAR1		(0x0414) /* Level 2 Interrupt Status and Acknowledgement Register (TX Part) */
...
#define CLDMA_AP_L3TISAR0		(0x0430) /* Level 3 Interrupt Status and Acknowledgement Register (TX Part) */
#define CLDMA_AP_L3TISAR1		(0x0434) /* Level 3 Interrupt Status and Acknowledgement Register (TX Part) */
...
#define CLDMA_AP_L2RISAR0		(0x0450) /* Level 2 Interrupt Status and Acknowledgement Register (RX Part) */
#define CLDMA_AP_L2RISAR1		(0x0454) /* Level 2 Interrupt Status and Acknowledgement Register (RX Part) */
#define CLDMA_AP_L3RISAR0		(0x0470) /* Level 3 Interrupt Status and Acknowledgement Register (RX Part) */
#define CLDMA_AP_L3RISAR1		(0x0474) /* Level 3 Interrupt Status and Acknowledgement Register (RX Part) */
...
#define CLDMA_AP_L3TISAR2               (0x04C0) /* Level3 Interrupt Status and Acknowledgement Register(TX Part) */
...
#define CLDMA_BM_INT_ERROR		0x00FF0000
	/* error occured on the specified queue, check L3 interrupt register for detail */
