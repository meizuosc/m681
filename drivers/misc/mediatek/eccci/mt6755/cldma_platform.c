...
void md1_pmic_setting_off(void)
{
	...
	pmic_set_register_value(PMIC_BUCK_VCORE2_VSLEEP_EN, 0); /* 1: enable, 0:disable */
	pmic_set_register_value(PMIC_BUCK_VCORE2_EN, 0); /* 1: enable, 0:disable */
...
void md1_pmic_setting_on(void)
{
	...
	pmic_set_register_value(PMIC_BUCK_VCORE2_VOSEL_CTRL, 1); /* switch to HW mode */
