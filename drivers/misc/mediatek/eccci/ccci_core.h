...
/* enlarge file name only for C2K Jade and later*/
#ifdef MD_UMOLY_EE_SUPPORT
...
{
	CCCI_REP_MSG(md->index, CORE, "traffic(ch): tx:[%d]%ld, [%d]%ld, [%d]%ld rx:[%d]%ld, [%d]%ld, [%d]%ld\n",
