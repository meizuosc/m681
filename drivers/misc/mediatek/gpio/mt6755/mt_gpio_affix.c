...
//Start: Req_Add detect card pin, lizheng, Add code, 2015/12/08
extern ssize_t mt_gpio_show_cardpin(struct device* dev, struct device_attribute *attr, char *buf);
static DEVICE_ATTR(cardpin,	0664, mt_gpio_show_cardpin, NULL);
//End: Req_Add detect card pin, lizheng, Add code, 2015/12/08
