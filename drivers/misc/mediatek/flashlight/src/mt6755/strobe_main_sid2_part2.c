...
// ANDROID_LOG_DEBUG
// ANDROID_LOG_VERBOSE
#define TAG_NAME "leds_LT_strobe_jerryxie_part2"
...
static u32 strobe_Res_L = 0;
/*****************************************************************************
Functions
*****************************************************************************/
static void work_timeOutFunc(struct work_struct *data);

extern int flashEnable_SY7806_2(void);
extern int flashDisable_SY7806_2(void);
//extern int readjust_part2_Duty_2(int duty);
extern int setDuty_SY7806_2(int duty);
extern int SY7806_FlashIc_Enable(void);
extern int SY7806_FlashIc_Disable(void);
extern int part2_gpio_init(void);
extern int m_part2_duty2;
extern int LED2Closeflag_part2;


u32 get_strobe_Res_L(void)
{
    return strobe_Res_L;
}
...
{
    //readjust_part2_Duty_2(duty);

    setDuty_SY7806_2(duty);
    return 0;
}
...
extern int g_part2_flash_gpio_init ;
static int FL_Init(void)
{
    PK_DBG("LED2_FL_Init! line=%d\n",__LINE__);
...
static int constant_flashlight_ioctl(unsigned int cmd, unsigned long arg)
{
	...
	PK_DBG("SY7806_LED2_constant_flashlight_ioctl() line=%d ior_shift=%d, iow_shift=%d iowr_shift=%d arg=%d\n",__LINE__, ior_shift, iow_shift, iowr_shift, (int)arg);
    switch(cmd)
    {
    	...
    	case FLASH_IOC_SET_ONOFF:
			...
			LED2Closeflag_part2 = 0;
			SY7806_FlashIc_Enable();
			FL_dim_duty(m_part2_duty2);
    			FL_Enable();
    		}
    		else
    		{
    			LED2Closeflag_part2 = 1;
			SY7806_FlashIc_Enable();
			FL_dim_duty(m_part2_duty2);
    			FL_Disable();
