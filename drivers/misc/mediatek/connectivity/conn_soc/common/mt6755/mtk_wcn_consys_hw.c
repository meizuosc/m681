...
#if CONSYS_PWR_ON_OFF_API_AVALIABLE
	INT32 iRet = -1;
#endif
...
/*step1.PMIC ctrl*/
		...
		if (co_clock_type) {
			...
			/*if NOT co-clock: */
#if defined (CONFIG_MTK_PMIC_CHIP_MT6353)
			/* 2.1.for jade minus:switch VCN28 to HW control mode (with PMIC_WRAP API) */
...
/*step2.MTCMOS ctrl*/
		...
		/*12.poll CONNSYS CHIP ID until 6755 is returned 0x18070008 32'h6755 */
		while (retry-- > 0) {
