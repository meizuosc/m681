...
typedef enum _PARAM_POWER_MODE {
	...
	Param_PowerModeKeepActiveOn,	/* priviledge mode, always active */
	Param_PowerModeKeepActiveOff,	/* to leave priviledge mode */
#endif
...
typedef struct _PARAM_CUSTOM_KEY_CFG_STRUC_T {
	UINT_8 aucKey[WLAN_CFG_KEY_LEN_MAX];
	UINT_8 aucValue[WLAN_CFG_VALUE_LEN_MAX];
} PARAM_CUSTOM_KEY_CFG_STRUC_T, *P_PARAM_CUSTOM_KEY_CFG_STRUC_T;
...
typedef struct _PARAM_CUSTOM_WFD_DEBUG_STRUC_T {
	...
	UINT_8 reserved;
} PARAM_CUSTOM_WFD_DEBUG_STRUC_T, *P_PARAM_CUSTOM_WFD_DEBUG_STRUC_T;
