...
/*Start:bug_317581 Changer:wangguolong.wt*/
/*Change reason:Don't force wifi use 20Bw so that wifi can use other bandwidth like 40Bw*/
#define CFG_FORCE_USE_20BW			0
/*End:bug_317581 Changer:wangguolong.wt*/
/*------------------------------------------------------------------------------
 * SLT Option
 *------------------------------------------------------------------------------
 */
