...
enum TestModeCmdType {
	...
	TESTMODE_CMD_ID_ALWAYSSCANSTATE = 102,	
...
typedef struct _NL80211_DRIVER_ALWAYSSCAN_PARAMS {
	NL80211_DRIVER_TEST_MODE_PARAMS hdr;
    UINT_8           alwaysscanstate;
}NL80211_DRIVER_ALWAYSSCAN_PARAMS, *P_NL80211_DRIVER_ALWAYSSCAN_PARAMS;
