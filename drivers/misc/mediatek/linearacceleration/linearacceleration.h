...
#define LA_ERR(fmt, args...)		pr_err(KERN_ERR LA_TAG"%s %d : "fmt, __func__, __LINE__, ##args)
#define LA_LOG(fmt, args...)		pr_debug(KERN_ERR LA_TAG fmt, ##args)
#define LA_VER(fmt, args...)   	pr_debug(KERN_ERR LA_TAG"%s: "fmt, __func__, ##args) //((void)0)
