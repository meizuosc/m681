...
#define GMRV_ERR(fmt, args...)		pr_err(KERN_ERR GMRV_TAG"%s %d : "fmt, __func__, __LINE__, ##args)
#define GMRV_LOG(fmt, args...)		pr_debug(KERN_ERR GMRV_TAG fmt, ##args)
#define GMRV_VER(fmt, args...)   	pr_debug(KERN_ERR GMRV_TAG"%s: "fmt, __func__, ##args) //((void)0)
#define GMRV_DBGMSG pr_debug("%s, %d\n", __func__, __LINE__);
#else
#define GMRV_TAG					"<GMRV> "
#define GMRV_FUN(f)	
