...
#define DP_COLOR_BITS_PER_PIXEL(color)    ((0x03F0000 & color) >>  16)
			       ...
			       struct ESD_PARA *data)
{
	...
	err |= put_user(d, &data->esd_ret_buffer);
			       ...
			       struct ESD_PARA *data)
{
	...
	err |= get_user(d, &data->esd_ret_buffer);
