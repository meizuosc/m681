...
/*******yuv test*****/
extern int yuvlayer_layerout[PRIMARY_SESSION_INPUT_LAYER_COUNT];
extern YUV_STAT_STRUCT yuv_stat[MAX_YUV_RECORD];
extern int yuv_stat_index;
/******end*********/

/* defined in mtkfb.c should move to mtkfb.h*/
extern unsigned int islcmconnected;
extern int _decouple_update_rdma_config_nolock(void);
extern const char *p_session_mode_spy(unsigned int mode);
extern int setup_disp_sec(disp_ddp_path_config *data_config, cmdqRecHandle cmdq_handle,
			  int is_locked);
