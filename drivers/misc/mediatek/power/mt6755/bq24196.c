...
#define BQ24196_BUSNUM I2C_SWITHING_CHARGER_CHANNEL
#else
#define BQ24196_BUSNUM 0
#endif
...
static void bq24196_shutdown(struct platform_device *dev)
{
	pr_debug("[bq24196_shutdown] driver shutdown\n");
	bq24196_set_chg_config(0x0);	/* charger disable */
}


#ifdef CONFIG_OF
static const struct of_device_id bq24196_of_match[] = {
	{.compatible = "bq24196",},
	{},
};

MODULE_DEVICE_TABLE(of, bq24196_of_match);
#endif
...
static struct i2c_driver bq24196_driver = {
	.driver = {
		   .name = "bq24196",
#ifdef CONFIG_OF
		   .of_match_table = bq24196_of_match,
#endif
		   },
...
I2C_BOARD_INFO("bq24196", (BQ24196_SLAVE_ADDR_WRITE >> 1)) };

static int __init bq24196_subsys_init(void)
{
	int ret = 0;

	pr_debug("[bq24196_init] init start. ch=%d\n", BQ24196_BUSNUM);
