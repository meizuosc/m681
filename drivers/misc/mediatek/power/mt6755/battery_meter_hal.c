...
kal_int32 fgauge_set_columb_interrupt_internal(void *data, int reset)
{
	...
	kal_int32 upperbound = 0, lowbound = 0;
	kal_int16 pcar = 0;
	kal_int16 m, i;
	kal_uint32 car = *(kal_uint32 *) (data);
	kal_uint32 ret = 0;

	kal_int32 value32_CAR;

	bm_print(BM_LOG_CRTI, "fgauge_set_columb_interrupt_internal car=%d\n", car);
...
*/
	...
	bm_print(BM_LOG_CRTI,
		 ...
		 uvalue32_CAR, uvalue32_CAR_MSB, (pmic_get_register_value(MT6351_PMIC_FG_CAR_18_03)), (pmic_get_register_value(MT6351_PMIC_FG_CAR_34_19)));
...
#if defined(SWCHR_POWER_PATH)
	*(kal_int32 *) (data) =
		PMIC_IMM_GetOneChannelValue(PMIC_AUX_ISENSE_AP, *(kal_int32 *) (data), 1);
#else
	*(kal_int32 *) (data) =
		PMIC_IMM_GetOneChannelValue(PMIC_AUX_BATSNS_AP, *(kal_int32 *) (data), 1);
#endif
#endif
...
static kal_int32 read_adc_v_bat_temp(void *data)
{
	...
	*(kal_int32 *) (data) =
	PMIC_IMM_GetOneChannelValue(PMIC_AUX_BATON_AP, *(kal_int32 *) (data), 1);
#endif
#endif
...
static kal_int32 read_adc_v_charger(void *data)
{
	...
	*(kal_int32 *) (data) = 5001;
	...
	val = PMIC_IMM_GetOneChannelValue(PMIC_AUX_VCDT_AP, *(kal_int32 *) (data), 1);
	val =
...
{
	*(kal_int32 *)(data) = is_battery_remove_pmic();
