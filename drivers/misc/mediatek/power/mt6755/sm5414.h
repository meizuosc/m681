...
/**********************************************************
  ...
  *
  *********************************************************/
extern void sm5414_set_enboost(kal_uint32 val);
extern void sm5414_set_chgen(kal_uint32 val);
extern void sm5414_set_suspen(kal_uint32 val);
extern void sm5414_set_reset(kal_uint32 val);
extern void sm5414_set_encomparator(kal_uint32 val);
extern void sm5414_set_vbuslimit(kal_uint32 val);
extern void sm5414_set_prechg(kal_uint32 val);
extern void sm5414_set_aiclen(kal_uint32 val);
extern void sm5414_set_autostop(kal_uint32 val);
extern void sm5414_set_aiclth(kal_uint32 val);
extern void sm5414_set_fastchg(kal_uint32 val);
extern void sm5414_set_weakbat(kal_uint32 val);
extern void sm5414_set_batreg(kal_uint32 val);
extern void sm5414_set_dislimit(kal_uint32 val);
extern void sm5414_set_topoff(kal_uint32 val);
extern void sm5414_set_topofftimer(kal_uint32 val);
extern void sm5414_set_fasttimer(kal_uint32 val);
extern void sm5414_set_votg(kal_uint32 val);

//---------------------------------------------------------
extern void sm5414_cnt_nshdn_pin(kal_uint32 enable);
extern void sm5414_otg_enable(kal_uint32 enable);
extern void sm5414_dump_register(void);
extern int sm5414_get_chrg_stat(void);
extern kal_uint32 sm5414_reg_config_interface (kal_uint8 RegNum, kal_uint8 val);

extern kal_uint32 sm5414_read_interface (kal_uint8 RegNum, kal_uint8 *val, kal_uint8 MASK, kal_uint8 SHIFT);
extern kal_uint32 sm5414_config_interface (kal_uint8 RegNum, kal_uint8 val, kal_uint8 MASK, kal_uint8 SHIFT);
#endif // _sm5414_SW_H_
