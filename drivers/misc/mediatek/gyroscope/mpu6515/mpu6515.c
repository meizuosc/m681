...
{
    obj->cali_sw[MPU6515_AXIS_X] = obj->cvt.sign[MPU6515_AXIS_X]*dat[obj->cvt.map[MPU6515_AXIS_X]];
    obj->cali_sw[MPU6515_AXIS_Y] = obj->cvt.sign[MPU6515_AXIS_Y]*dat[obj->cvt.map[MPU6515_AXIS_Y]];
    obj->cali_sw[MPU6515_AXIS_Z] = obj->cvt.sign[MPU6515_AXIS_Z]*dat[obj->cvt.map[MPU6515_AXIS_Z]];
#if DEBUG		
    if (atomic_read(&obj->trace) & GYRO_TRC_CALI)
    {
        GYRO_LOG("test  (%5d, %5d, %5d) ->(%5d, %5d, %5d)->(%5d, %5d, %5d))\n", 
                 obj->cvt.sign[MPU6515_AXIS_X],obj->cvt.sign[MPU6515_AXIS_Y],obj->cvt.sign[MPU6515_AXIS_Z],
                 dat[MPU6515_AXIS_X], dat[MPU6515_AXIS_Y], dat[MPU6515_AXIS_Z],
                 obj->cvt.map[MPU6515_AXIS_X],obj->cvt.map[MPU6515_AXIS_Y],obj->cvt.map[MPU6515_AXIS_Z]);
...
static int MPU6515_ReadCalibration(struct i2c_client *client, int dat[MPU6515_AXES_NUM])
{
    ...
    dat[obj->cvt.map[MPU6515_AXIS_X]] = obj->cvt.sign[MPU6515_AXIS_X]*obj->cali_sw[MPU6515_AXIS_X];
    dat[obj->cvt.map[MPU6515_AXIS_Y]] = obj->cvt.sign[MPU6515_AXIS_Y]*obj->cali_sw[MPU6515_AXIS_Y];
    dat[obj->cvt.map[MPU6515_AXIS_Z]] = obj->cvt.sign[MPU6515_AXIS_Z]*obj->cali_sw[MPU6515_AXIS_Z];
...
static int MPU6515_WriteCalibration(struct i2c_client *client, int dat[MPU6515_AXES_NUM])
{
    ...
    {
        cali[obj->cvt.map[MPU6515_AXIS_X]] = obj->cvt.sign[MPU6515_AXIS_X]*obj->cali_sw[MPU6515_AXIS_X];
        cali[obj->cvt.map[MPU6515_AXIS_Y]] = obj->cvt.sign[MPU6515_AXIS_Y]*obj->cali_sw[MPU6515_AXIS_Y];
        cali[obj->cvt.map[MPU6515_AXIS_Z]] = obj->cvt.sign[MPU6515_AXIS_Z]*obj->cali_sw[MPU6515_AXIS_Z]; 
    ...
    *datalen = packet_cnt;
    ...
    if (packet_cnt && (abs(packet_thresh -packet_cnt) < 4))
    {
        ...
        for (i = 0; i < packet_cnt; i++)
        {
            ...
            tmp1[MPU6515_AXIS_X] = (s16)((buf[MPU6515_AXIS_X*2+1]) | (buf[MPU6515_AXIS_X*2] << 8));
            tmp1[MPU6515_AXIS_Y] = (s16)((buf[MPU6515_AXIS_Y*2+1]) | (buf[MPU6515_AXIS_Y*2] << 8));
            tmp1[MPU6515_AXIS_Z] = (s16)((buf[MPU6515_AXIS_Z*2+1]) | (buf[MPU6515_AXIS_Z*2] << 8));

            //remap coordinate//
            tmp2[obj->cvt.map[MPU6515_AXIS_X]] = obj->cvt.sign[MPU6515_AXIS_X]*tmp1[MPU6515_AXIS_X];
            tmp2[obj->cvt.map[MPU6515_AXIS_Y]] = obj->cvt.sign[MPU6515_AXIS_Y]*tmp1[MPU6515_AXIS_Y];
            tmp2[obj->cvt.map[MPU6515_AXIS_Z]] = obj->cvt.sign[MPU6515_AXIS_Z]*tmp1[MPU6515_AXIS_Z];
            ...
            GYRO_LOG("gyro FIFO packet[%d]:[%04X %04X %04X] => [%5d %5d %5d]\n", i, 
                     data[3*i +MPU6515_AXIS_X], data[3*i +MPU6515_AXIS_Y], data[3*i +MPU6515_AXIS_Z], 
                     data[3*i +MPU6515_AXIS_X], data[3*i +MPU6515_AXIS_Y], data[3*i +MPU6515_AXIS_Z]);
        }
...
static int MPU6515_ReadGyroData(struct i2c_client *client, char *buf, int bufsize)
{
    ...
    {
        obj->data[MPU6515_AXIS_X] = ((s16)((databuf[MPU6515_AXIS_X*2+1]) | (databuf[MPU6515_AXIS_X*2] << 8)));
        obj->data[MPU6515_AXIS_Y] = ((s16)((databuf[MPU6515_AXIS_Y*2+1]) | (databuf[MPU6515_AXIS_Y*2] << 8)));
        obj->data[MPU6515_AXIS_Z] = ((s16)((databuf[MPU6515_AXIS_Z*2+1]) | (databuf[MPU6515_AXIS_Z*2] << 8)));
#if DEBUG		
        if (atomic_read(&obj->trace) & GYRO_TRC_RAWDATA)
        {
            ...
            GYRO_LOG("get gyro raw data (0x%08X, 0x%08X, 0x%08X) -> (%5d, %5d, %5d)\n", 
                     obj->data[MPU6515_AXIS_X],obj->data[MPU6515_AXIS_Y],obj->data[MPU6515_AXIS_Z],
                     obj->data[MPU6515_AXIS_X],obj->data[MPU6515_AXIS_Y],obj->data[MPU6515_AXIS_Z]);
        }
#endif		
#if INV_GYRO_AUTO_CALI==1
        ...
        /*remap coordinate*/
        obj->inv_cali_raw[obj->cvt.map[MPU6515_AXIS_X]] = obj->cvt.sign[MPU6515_AXIS_X]*obj->data[MPU6515_AXIS_X];
        obj->inv_cali_raw[obj->cvt.map[MPU6515_AXIS_Y]] = obj->cvt.sign[MPU6515_AXIS_Y]*obj->data[MPU6515_AXIS_Y];
        obj->inv_cali_raw[obj->cvt.map[MPU6515_AXIS_Z]] = obj->cvt.sign[MPU6515_AXIS_Z]*obj->data[MPU6515_AXIS_Z];
        mutex_unlock(&obj->raw_data_mutex);
#endif
        obj->data[MPU6515_AXIS_X] = obj->data[MPU6515_AXIS_X] + obj->cali_sw[MPU6515_AXIS_X];
        obj->data[MPU6515_AXIS_Y] = obj->data[MPU6515_AXIS_Y] + obj->cali_sw[MPU6515_AXIS_Y];
        obj->data[MPU6515_AXIS_Z] = obj->data[MPU6515_AXIS_Z] + obj->cali_sw[MPU6515_AXIS_Z];

        /*remap coordinate*/
        data[obj->cvt.map[MPU6515_AXIS_X]] = obj->cvt.sign[MPU6515_AXIS_X]*obj->data[MPU6515_AXIS_X];
        data[obj->cvt.map[MPU6515_AXIS_Y]] = obj->cvt.sign[MPU6515_AXIS_Y]*obj->data[MPU6515_AXIS_Y];
        data[obj->cvt.map[MPU6515_AXIS_Z]] = obj->cvt.sign[MPU6515_AXIS_Z]*obj->data[MPU6515_AXIS_Z];

        //Out put the degree/second(o/s)
        data[MPU6515_AXIS_X] = data[MPU6515_AXIS_X] * MPU6515_FS_MAX_LSB / MPU6515_DEFAULT_LSB;
        data[MPU6515_AXIS_Y] = data[MPU6515_AXIS_Y] * MPU6515_FS_MAX_LSB / MPU6515_DEFAULT_LSB;
        data[MPU6515_AXIS_Z] = data[MPU6515_AXIS_Z] * MPU6515_FS_MAX_LSB / MPU6515_DEFAULT_LSB;


    }

    sprintf(buf, "%04x %04x %04x", data[MPU6515_AXIS_X],data[MPU6515_AXIS_Y],data[MPU6515_AXIS_Z]);
...
static int MPU6515_PROCESS_SMT_DATA(struct i2c_client *client, short *data)
{
	...
	/*
	FLPLOGD("read gyro data OK: packet_num:%d, [X:%5d, Y:%5d, Z:%5d]\n", i, data[MPU6515_AXES_NUM*i + MPU6515_AXIS_X +2], data[MPU6515_AXES_NUM*i + MPU6515_AXIS_Y +2], data[MPU6515_AXES_NUM*i + MPU6515_AXIS_Z +2]);
    ...
    for ( i = 0; i < total_num ; i++)
    {
        xRMS += (data[MPU6515_AXES_NUM*i + MPU6515_AXIS_X+2]-xAvg)*(data[MPU6515_AXES_NUM*i + MPU6515_AXIS_X+2]-xAvg);
        yRMS += (data[MPU6515_AXES_NUM*i + MPU6515_AXIS_Y+2]-yAvg)*(data[MPU6515_AXES_NUM*i + MPU6515_AXIS_Y+2]-yAvg);
        zRMS += (data[MPU6515_AXES_NUM*i + MPU6515_AXIS_Z+2]-zAvg)*(data[MPU6515_AXES_NUM*i + MPU6515_AXIS_Z+2]-zAvg);        
    }
...
static int MPU6515_ReadGyroDataRaw(struct i2c_client *client, char *buf, int bufsize)
{
    ...
    sprintf(buf, "%x %x %x", obj->inv_cali_raw[MPU6515_AXIS_X],obj->inv_cali_raw[MPU6515_AXIS_Y],obj->inv_cali_raw[MPU6515_AXIS_Z]);
       ...
       unsigned long arg)
{
    ...
    case GYROSCOPE_IOCTL_SET_CALI:
        ...
        {
            cali[MPU6515_AXIS_X] = sensor_data.x * MPU6515_DEFAULT_LSB / MPU6515_FS_MAX_LSB;
            cali[MPU6515_AXIS_Y] = sensor_data.y * MPU6515_DEFAULT_LSB / MPU6515_FS_MAX_LSB;
            cali[MPU6515_AXIS_Z] = sensor_data.z * MPU6515_DEFAULT_LSB / MPU6515_FS_MAX_LSB;              
...
static int gyroscope_enable_nodata(int en)
{
	...
	else
	{
		...
		{
			GYRO_LOG("Gsensor in suspend and can not enable or disable!enable_status = %d\n",enable_status);
		}
	}
