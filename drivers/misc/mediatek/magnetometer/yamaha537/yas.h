...
#define YLOGD(args) (pr_debug args)	/*!< Debug log (DEBUG) */
#define YLOGI(args) (pr_debug args)	/*!< Debug log (INFO) */
#define YLOGE(args) (pr_debug args)	/*!< Debug log (ERROR) */
#define YLOGW(args) (pr_debug args)	/*!< Debug log (WARNING) */
