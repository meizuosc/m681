...
int hdmi_audio_config(int format)
{
	...
	unsigned int bitWidth = (format & 0x180) >> 7, sampleBit;
...
int hdmi_get_dev_info(int is_sf, void *info)
{
	...
	if (is_sf == AP_GET_INFO) {
		...
		if (hdmi_reschange == HDMI_VIDEO_720x480p_60Hz || hdmi_reschange == HDMI_VIDEO_1280x720p_60Hz || hdmi_reschange == HDMI_VIDEO_1920x1080p_60Hz)
...
void hdmi_init(void)
{
	int ret = 0;
	int boot_mode = 0;
	EXTD_DRIVER *extd_factory_driver = NULL;
