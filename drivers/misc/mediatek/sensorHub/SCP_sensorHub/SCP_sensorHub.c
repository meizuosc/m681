...
#undef CONFIG_CUSTOM_KERNEL_HEART_RATE_SENSOR
#undef CONFIG_CUSTOM_KERNEL_TILT_DETECTOR_SENSOR
#undef CONFIG_CUSTOM_KERNEL_WAKE_GESTURE_SENSOR
#undef CONFIG_CUSTOM_KERNEL_GLANCE_GESTURE_SENSOR
/*----------------------------------------------------------------------------*/
