...
#define FIRMWARE_VERSION_3_2_3 323
#define FIRMWARE_VERSION FIRMWARE_VERSION_3_2_3
...
#define QUICK_FIX_MAG_ISSUE
#define SENSOR_HUB_BATCH
...
#ifdef QUICK_FIX_MAG_ISSUE
	bool is_sensor_installed[INV_SENSOR_MAX_NUM];
#endif
...
#define HAL_DIV_GYROSCOPE 917 // scale = 1/16, unit : dps, radian =  dps * (pi * / 180 / 16)
