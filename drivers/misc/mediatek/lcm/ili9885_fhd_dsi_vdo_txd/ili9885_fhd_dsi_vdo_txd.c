...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_frontporch	= 80;//80--64;   //64
...
static void lcm_init_power(void)
{
	...
	MDELAY(10);	
#endif
    LCM_LOGI("ili9885_fhd_dsi_vdo_txd lcm_init_power is called\n");
}

static void lcm_suspend_power(void)
{
    LCM_LOGI("ili9885_fhd_dsi_vdo_txdlcm_suspend_power  is called\n");
}

static void lcm_resume_power(void)
{
    lcm_init_power();
    LCM_LOGI("ili9885_fhd_dsi_vdo_txd lcm_resume_power is called\n");
}
...
static void lcm_init(void)
{
	...
	LCM_LOGI("ili9885_fhd_dsi_vdo_txd is init\n");
}
...
LCM_DRIVER ili9885_fhd_dsi_vdo_txd_lcm_drv = {
	.name = "ili9885_fhd_dsi_vdo_txd",
