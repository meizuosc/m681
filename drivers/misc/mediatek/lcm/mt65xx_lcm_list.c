...
//Start:Req90136,liuyang3.wt,ADD,20151124,add lcm driver
//#if defined(HX8399C_FHD_DSI_VDO_TCL_NT50358)
//  &hx8399c_fhd_dsi_vdo_tcl_nt50358_lcm_drv,
//#endif

#if defined(HX8399C_FHD_DSI_VDO_TXD_NT50358)
  &hx8399c_fhd_dsi_vdo_txd_nt50358_lcm_drv,
#endif

#if defined(HX8398A_FHD_DSI_VDO_YASSY_NT50358)
  &hx8398a_fhd_dsi_vdo_yassy_nt50358_lcm_drv,
#endif

#if defined(OTM1901A_FHD_DSI_VDO_DJN)
  &otm1901a_fhd_dsi_vdo_djn_lcm_drv,
#endif

#if defined(R63350_FHD_DSI_VDO_TCL_NT50358)
  &r63350_fhd_dsi_vdo_tcl_nt50358_lcm_drv,
#endif

#if defined(R63350_FHD_DSI_VDO_TCL_SHARP_NT50358)
  &r63350_fhd_dsi_vdo_tcl_sharp_nt50358_lcm_drv,
#endif

#if defined(NT35596_FHD_DSI_VDO_SHARP)   //add 20160513 by liuyang3.wt
  &nt35596_fhd_dsi_vdo_sharp_lcm_drv,
#endif

#if defined(ILI9885_FHD_DSI_VDO_TXD)   //add 20160514
  &ili9885_fhd_dsi_vdo_txd_lcm_drv,
#endif

#if defined(ILI9885_FHD_DSI_VDO_TXD1)   //add 20160514
  &ili9885_fhd_dsi_vdo_txd_lcm_drv1,
#endif

#if defined(ILI9885_FHD_DSI_VDO_DJN)   //add 20160526
  &ili9885_fhd_dsi_vdo_djn_lcm_drv,
#endif
//End:Req90136,liuyang3.wt,ADD,20151124,add lcm driver
};
