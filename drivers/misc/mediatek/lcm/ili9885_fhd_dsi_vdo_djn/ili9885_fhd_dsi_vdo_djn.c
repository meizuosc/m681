...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.lcm_esd_check_table[1].para_list[0] = 0x6D;
	params->dsi.lcm_esd_check_table[1].para_list[1] = 0x92;
	params->dsi.lcm_esd_check_table[1].para_list[2] = 0x80;
	params->dsi.lcm_esd_check_table[1].para_list[3] = 0x34;

	params->dsi.lcm_esd_check_table[1].para_list[4] = 0x76;
	params->dsi.lcm_esd_check_table[1].para_list[5] = 0x12;
	params->dsi.lcm_esd_check_table[1].para_list[6] = 0x12;
	params->dsi.lcm_esd_check_table[1].para_list[7] = 0x00;
	params->dsi.lcm_esd_check_table[1].para_list[8] = 0x00;
	params->dsi.lcm_esd_check_table[1].para_list[9] = 0x36;
...
static void lcm_init_power(void)
{
	...
	MDELAY(10);
#endif
    LCM_LOGI("liuyang:ili9885_fhd_dsi_vdo_txd is called\n");
}
...
{
    lcm_init_power();
    LCM_LOGI("ili9885_fhd_dsi_vdo_txd lcm_resume_power...\n");
}
...
static void lcm_init(void)
{
	...
	LCM_LOGI("ili9885_fhd_dsi_vdo_djn is init\n");
}
...
LCM_DRIVER ili9885_fhd_dsi_vdo_djn_lcm_drv = {
	.name = "ili9885_fhd_dsi_vdo_djn",
