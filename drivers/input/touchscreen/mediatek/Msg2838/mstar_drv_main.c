...
u8 ges_three_byte_one = 0;
u8 ges_three_byte_two = 0;
u8 ges_three_byte_three = 0;
u8 ges_three_byte_four = 0;
int ges_data= 0;
#endif
...
{
    DBG("gesture_data_show gesture_data=%x\n",ges_data);
...
{  
    ...
    if(value2 == 1)
    {
    	ges_three_byte_one = value1;
    }
    else if(value2 == 2)
    {
    	ges_three_byte_two = value1;
    }
    else if(value2 == 3)
    {
    	ges_three_byte_three = value1;
    }
    else if(value2 == 4)
    {
    	ges_three_byte_four = value1;
    }
    DBG("gesture_three_byte_one=%x,gesture_three_byte_two=%x,gesture_three_byte_three=%x,gesture_three_byte_four=%x\n",ges_three_byte_one,ges_three_byte_two,ges_three_byte_three,ges_three_byte_four);
    return count;
}
/*----------------------------------------------------------------------------*/
...
{  
    if(buf[2] == 1)
    {
    	ges_three_byte_one = buf[0];
    }
    else if(buf[2] == 2)
    {
    	ges_three_byte_two = buf[0];
    }
    else if(buf[2] == 3)
    {
    	ges_three_byte_three = buf[0];
    }
    else if(buf[2] == 4)
    {
    	ges_three_byte_four = buf[0];
    }
    DBG("gesture_three_byte_one=%x,gesture_three_byte_two=%x,gesture_three_byte_three=%x,gesture_three_byte_four=%x\n",ges_three_byte_one,ges_three_byte_two,ges_three_byte_three,ges_three_byte_four);
...
void DrvMainTouchGetHwInfo(void)
{
    u16 nMajor = 0, nMinor = 0;
    u8 *pVersion = NULL;
    DrvFwCtrlGetCustomerFirmwareVersion(&nMajor, &nMinor, &pVersion);
    sprintf(tp_info,"msg2838_holitech,ver:%01d.%03d", nMajor, nMinor);
}
