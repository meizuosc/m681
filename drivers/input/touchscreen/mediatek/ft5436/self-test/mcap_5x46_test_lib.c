    ...
    for (i = 0; i < TX_NUM_MAX; i++)
    {
        ...
        if (valuelen > 0)
        {
            ...
            for (j = 0; j < valuelen; j++)
            {
                if (',' == str_value[j])
                {
                    g_TestParam_FT5X46.RawDataTest_Low_Min_node[i][k] = (short)(atoi_atol(str_tmp));
                    index = 0;
                    memset(str_tmp, 0x00, sizeof(str_tmp));
                    k++;
                }
    ...
    for (i = 0; i < TX_NUM_MAX; i++)
    {
        ...
        if (valuelen > 0)
        {
            ...
            for (j = 0; j < valuelen; j++)
            {
                if (',' == str_value[j])
                {
                    g_TestParam_FT5X46.RawDataTest_Low_Max_node[i][k] = (short)(atoi_atol(str_tmp));
                    index = 0;
                    memset(str_tmp, 0x00, sizeof(str_tmp));
                    k++;
                }
    ...
    for (i = 0; i < TX_NUM_MAX; i++)
    {
        ...
        if (valuelen > 0)
        {
            ...
            for (j = 0; j < valuelen; j++)
            {
                if (',' == str_value[j])
                {
                    g_TestParam_FT5X46.RawDataTest_High_Min_node[i][k] = (short)(atoi_atol(str_tmp));
                    index = 0;
                    memset(str_tmp, 0x00, sizeof(str_tmp));
                    k++;
                }
    ...
    for (i = 0; i < TX_NUM_MAX; i++)
    {
        ...
        if (valuelen > 0)
        {
            ...
            for (j = 0; j < valuelen; j++)
            {
                if (',' == str_value[j])
                {
                    g_TestParam_FT5X46.RawDataTest_High_Max_node[i][k] = (short)(atoi_atol(str_tmp));
                    index = 0;
                    memset(str_tmp, 0x00, sizeof(str_tmp));
                    k++;
                }
...
static boolean TestItem_RawDataTest_FT5X46(void)
{
    ...
    if (g_TestParam_FT5X46.RawDataTest_LowFreq == 1)
    {
        ...
        for (i = 0; i < iTxNum; i++)
        {
            for (j = 0; j < iRxNum; j++)
            {
                if (0 == g_TestParam_FT5X46.valid_node[i][j])
                {
                    continue;
                }
